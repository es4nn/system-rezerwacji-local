...
- kod z `hotel-backend/app`, `config`, `database`, `resources`, `routes`, `tests`,
- kod z `hotel-frontend/src`,
- pliki konfiguracyjne projektu bez sekretow,
- `hotel-backend/.env.example`,
- migracje i seedery,
- obrazy demo w `hotel-backend/database/seeders/demo-images`,
- katalog `docs`,
- `README.md`.

## Czego nie wrzucac na GitHub

- `hotel-backend/.env`,
- hasel SMTP,
- danych produkcyjnej bazy,
- tokenow i prywatnych kluczy,
- `vendor/`,
- `node_modules/`,
- `dist/`,
- `storage/logs/`,
- cache z `bootstrap/cache/*.php`,
- plikow `*.log`.
